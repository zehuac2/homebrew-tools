...
class Latextools < Formula
  ...
  homepage "https://github.com/zehuac2/latextools"
  version "0.7.0"
  license "MIT"

  if Hardware::CPU.arm?
    url "https://github.com/zehuac2/latextools/releases/download/0.7.0/latextools-osx-arm64.tar.gz"
    sha256 "810a25f2e7721c71f2113ccad2b79a82212d347e0d3a85c81ea7708a7b1de438"
  else
    url "https://github.com/zehuac2/latextools/releases/download/0.7.0/latextools-osx-x64.tar.gz"
